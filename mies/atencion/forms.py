...
AtencionCabDetalleSecundariaForm = inlineformset_factory(AtencionSecundaria,AtencionSecundariaDetalle,
    form=AtencionDetalleSecundariaForm, extra=1,can_delete= True) 