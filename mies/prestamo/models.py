...
class Prestamo(models.Model):
    ...
    item = models.ForeignKey(InventarioTics, on_delete=models.CASCADE,verbose_name='Item')
    cantidad = models.IntegerField('Cantidad',default =1)
    condicion = models.ForeignKey(Condicion, on_delete=models.CASCADE, verbose_name="estado de la  devolución", null=True, blank=True)
